...
1. **Initial setup** (only do this once)
    ...
    Then you can create and activate a new Python environment by running:
        ...
        conda create -n mixture-of-depths-jax python=3.9
        conda activate mixture-of-depths-jax
...
4. **Test your changes**
    ...
    For example, if you've fixed a bug in `mixture_of_depths_jax/a/b.py`, you can run the tests specific to that module with
